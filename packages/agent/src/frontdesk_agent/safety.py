...
EMERGENCY = re.compile(r"chest pain|can.?t breathe|cannot breathe|severe bleeding|suicid|kill myself|end my life|overdose|unconscious|not breathing", re.I)
INJECTION = re.compile(r"ignore|system prompt|developer says|override|jailbreak|pretend|bypass|skip verification|you are now|reveal|booked without|just (say|tell)|forget (your|all)|act as", re.I)
MEDICAL = re.compile(r"symptom|diagnos|pain|fever|rash|bleed|sick|cough|dizz|pregnan|condition|medical advice|treat|disease|blood|cancer|diabet", re.I)
PRESCRIPTION = re.compile(r"prescri|medicat|dosage|dose|antibiotic|refill|pill|drug", re.I)
OTHER = re.compile(r"someone else|another patient|other patient|my (wife|husband|friend|mother|father)|their booking|all patients|under.*name|phone number", re.I)
