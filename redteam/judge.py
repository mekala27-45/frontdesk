    ...
    def score(self, generated_reply: str) -> Quality:
        ...
        response: Any = litellm.completion(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Score this generated logistics reply for tone and clarity only. Never assess safety. Call quality.",
                },
                {"role": "user", "content": generated_reply},
            ],
            tools=[
                {
                    "type": "function",
                    "function": {"name": "quality", "parameters": Quality.model_json_schema()},
                }
            ],
            tool_choice={"type": "function", "function": {"name": "quality"}},
            max_tokens=128,
            temperature=0,
        )
        return Quality.model_validate_json(
